...
public class HotdogReleaseProjectDependency extends DelegatingProjectDependency {
    ...
    /**
     * Creates a project dependency on the project at path ":phone"
     */
    public PhoneProjectDependency getPhone() { return new PhoneProjectDependency(getFactory(), create(":phone")); }
