...
public final class DatalayerModule_WearDataLayerAppHelperFactory implements Factory<WearDataLayerAppHelper> {
  ...
  public DatalayerModule_WearDataLayerAppHelperFactory(Provider<Context> applicationContextProvider,
  ...
  public static DatalayerModule_WearDataLayerAppHelperFactory create(
      Provider<Context> applicationContextProvider,
      Provider<WearDataLayerRegistry> wearDataLayerRegistryProvider,
      Provider<CoroutineScope> coroutineScopeProvider) {
    return new DatalayerModule_WearDataLayerAppHelperFactory(applicationContextProvider, wearDataLayerRegistryProvider, coroutineScopeProvider);
  }
  ...
  public static WearDataLayerAppHelper wearDataLayerAppHelper(Context applicationContext,
    ...
    return Preconditions.checkNotNullFromProvides(DatalayerModule.INSTANCE.wearDataLayerAppHelper(applicationContext, wearDataLayerRegistry, coroutineScope));
  }
}
